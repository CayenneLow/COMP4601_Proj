...
architecture behav of huffman_encoding is 
    ...
    "huffman_encoding,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.661000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=22,HLS_SYN_DSP=0,HLS_SYN_FF=5026,HLS_SYN_LUT=6156,HLS_VERSION=2020_1}";
...
begin
    ...
    filtered_frequency_V_U : component huffman_encoding_mb6
    generic map (
        DataWidth => 32,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sorted_1_U : component huffman_encoding_mb6
    generic map (
        DataWidth => 32,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sorted_copy1_value_V_U : component huffman_encoding_mb6
    generic map (
        DataWidth => 32,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    sorted_copy1_frequen_U : component huffman_encoding_mb6
    generic map (
        DataWidth => 32,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    left_V_U : component huffman_encoding_udo
    generic map (
        DataWidth => 32,
        AddressRange => 255,
        AddressWidth => 8)
    ...
    right_V_U : component huffman_encoding_udo
    generic map (
        DataWidth => 32,
        AddressRange => 255,
        AddressWidth => 8)
    ...
    length_histogram_V_U : component huffman_encoding_wdI
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    port map (
        ...
        i_write => truncate_tree_U0_ap_done,
    ...
    ap_channel_done_truncated_length_his <= truncate_tree_U0_ap_done;
    ap_done <= ap_sync_done;
    ap_idle <= (truncate_tree_U0_ap_idle and sort_U0_ap_idle and filter_U0_ap_idle and (symbol_bits_V_t_empty_n xor ap_const_logic_1) and (truncated_length_his_t_empty_n xor ap_const_logic_1) and (length_histogram_V_t_empty_n xor ap_const_logic_1) and (right_V_t_empty_n xor ap_const_logic_1) and (left_V_t_empty_n xor ap_const_logic_1) and (parent_V_t_empty_n xor ap_const_logic_1) and (sorted_copy2_value_V_t_empty_n xor ap_const_logic_1) and (sorted_copy1_frequen_t_empty_n xor ap_const_logic_1) and (sorted_copy1_value_V_t_empty_n xor ap_const_logic_1) and (sorted_1_t_empty_n xor ap_const_logic_1) and (sorted_0_t_empty_n xor ap_const_logic_1) and (filtered_frequency_V_t_empty_n xor ap_const_logic_1) and (filtered_value_V_t_empty_n xor ap_const_logic_1) and create_tree_U0_ap_idle and create_codeword_U0_ap_idle and compute_bit_length_U0_ap_idle and canonize_tree_U0_ap_idle and Loop_copy_sorted_pro_U0_ap_idle and Block_proc_U0_ap_idle);
    ap_ready <= filter_U0_ap_ready;
    ...
    create_codeword_U0_ap_start <= symbol_bits_V_t_empty_n;
    ...
    truncate_tree_U0_ap_continue <= truncated_length_his_i_full_n;
