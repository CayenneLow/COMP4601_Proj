...
Block_proc::Block_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    ap_CS_fsm = "1";
    num_nonzero_symbols_preg = "00000000000000000000000000000000";
...
void Block_proc::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
             !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, val_assign_loc_empty_n.read())))) {
            num_nonzero_symbols_preg = val_assign_loc_dout.read();
        }
    }
}
...
void Block_proc::thread_num_nonzero_symbols() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, val_assign_loc_empty_n.read())))) {
        num_nonzero_symbols = val_assign_loc_dout.read();
    } else {
        num_nonzero_symbols = num_nonzero_symbols_preg.read();
    }
}

void Block_proc::thread_num_nonzero_symbols_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, val_assign_loc_empty_n.read())))) {
