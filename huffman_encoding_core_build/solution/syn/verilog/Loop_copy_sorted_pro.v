...
reg   [31:0] n_read_reg_164;
reg    ap_block_state1;
wire   [30:0] i_fu_152_p2;
reg   [30:0] i_reg_174;
reg    ap_block_state2;
wire   [63:0] zext_ln43_fu_158_p1;
reg   [63:0] zext_ln43_reg_179;
reg   [30:0] i_0_i_reg_132;
wire    ap_CS_fsm_state3;
wire   [31:0] zext_ln42_fu_143_p1;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0))) & (icmp_ln42_fu_147_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0))) & (icmp_ln42_fu_147_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        zext_ln43_reg_179[30 : 0] <= zext_ln43_fu_158_p1[30 : 0];
    end
end

always @ (*) begin
    if ((~(((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0))) & (icmp_ln42_fu_147_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln42_fu_147_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0))) & (icmp_ln42_fu_147_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0))) & (icmp_ln42_fu_147_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = (((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out1_full_n == 1'b0)) | ((icmp_ln42_fu_147_p2 == 1'd0) & (val_assign_out_out_full_n == 1'b0)));
end

assign ap_ready = internal_ap_ready;

assign i_fu_152_p2 = (i_0_i_reg_132 + 31'd1);

assign icmp_ln42_fu_147_p2 = (($signed(zext_ln42_fu_143_p1) < $signed(n_read_reg_164)) ? 1'b1 : 1'b0);

assign sorted_0_address0 = zext_ln43_fu_158_p1;

assign sorted_1_address0 = zext_ln43_fu_158_p1;

assign sorted_copy1_frequency_V_address0 = zext_ln43_reg_179;

assign sorted_copy1_frequency_V_d0 = sorted_1_q0;

assign sorted_copy1_value_V_address0 = zext_ln43_reg_179;

assign sorted_copy1_value_V_d0 = sorted_0_q0;

assign sorted_copy2_value_V_address0 = zext_ln43_reg_179;

assign sorted_copy2_value_V_d0 = sorted_0_q0;

assign start_out = real_start;

assign val_assign_out_out1_din = n_read_reg_164;

assign val_assign_out_out_din = n_read_reg_164;

assign zext_ln42_fu_143_p1 = i_0_i_reg_132;

assign zext_ln43_fu_158_p1 = i_0_i_reg_132;

always @ (posedge ap_clk) begin
    zext_ln43_reg_179[63:31] <= 33'b000000000000000000000000000000000;
end
