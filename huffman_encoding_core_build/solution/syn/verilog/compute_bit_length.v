...
always @ (posedge ap_clk) begin
    if (((tmp_2_fu_237_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        zext_ln24_reg_318[31 : 0] <= zext_ln24_fu_245_p1[31 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        child_depth_V_address0 = zext_ln24_reg_318;
...
assign left_V_address0 = zext_ln24_reg_318;
...
assign parent_V_address0 = zext_ln24_fu_245_p1;

assign right_V_address0 = zext_ln24_reg_318;
...
assign zext_ln24_fu_245_p1 = i2_0_reg_182;
...
always @ (posedge ap_clk) begin
    zext_ln24_reg_318[63:32] <= 32'b00000000000000000000000000000000;
