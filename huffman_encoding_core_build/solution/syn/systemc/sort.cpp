...
sort::sort(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln40_fu_484_p2);
    ...
    sensitive << ( zext_ln31_reg_616 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_CS_fsm_state12 );
    sensitive << ( zext_ln44_fu_525_p1 );
    ...
    sensitive << ( zext_ln26_fu_437_p1 );
    sensitive << ( zext_ln544_fu_467_p1 );
    sensitive << ( zext_ln40_1_fu_490_p1 );
    ...
    SC_METHOD(thread_icmp_ln18_fu_396_p2);
    ...
    SC_METHOD(thread_icmp_ln30_fu_442_p2);
    sensitive << ( num_symbols );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( j5_0_reg_362 );

    SC_METHOD(thread_icmp_ln39_fu_478_p2);
    sensitive << ( ap_CS_fsm_state10 );
    sensitive << ( i6_0_reg_373 );
    ...
    sensitive << ( zext_ln19_reg_571 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( zext_ln31_fu_453_p1 );
    ...
    SC_METHOD(thread_zext_ln19_fu_407_p1);
    sensitive << ( j_0_reg_328 );

    SC_METHOD(thread_zext_ln23_fu_413_p1);
    sensitive << ( op2_assign_reg_339 );

    SC_METHOD(thread_zext_ln26_fu_437_p1);
    sensitive << ( i_0_reg_351 );

    SC_METHOD(thread_zext_ln31_fu_453_p1);
    sensitive << ( j5_0_reg_362 );

    SC_METHOD(thread_zext_ln40_1_fu_490_p1);
    sensitive << ( add_ln40_fu_484_p2 );

    SC_METHOD(thread_zext_ln40_fu_496_p1);
    sensitive << ( i6_0_reg_373 );

    SC_METHOD(thread_zext_ln44_fu_525_p1);
    sensitive << ( j7_0_reg_385 );
    ...
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( icmp_ln18_fu_396_p2 );
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( ap_CS_fsm_state6 );
    sensitive << ( icmp_ln30_fu_442_p2 );
    sensitive << ( ap_CS_fsm_state10 );
    sensitive << ( icmp_ln39_fu_478_p2 );
    sensitive << ( ap_CS_fsm_state12 );
    ...
    sc_trace(mVcdFile, zext_ln19_fu_407_p1, "zext_ln19_fu_407_p1");
    sc_trace(mVcdFile, zext_ln19_reg_571, "zext_ln19_reg_571");
    sc_trace(mVcdFile, icmp_ln18_fu_396_p2, "icmp_ln18_fu_396_p2");
    sc_trace(mVcdFile, zext_ln23_fu_413_p1, "zext_ln23_fu_413_p1");
    sc_trace(mVcdFile, zext_ln23_reg_592, "zext_ln23_reg_592");
    ...
    sc_trace(mVcdFile, zext_ln31_fu_453_p1, "zext_ln31_fu_453_p1");
    sc_trace(mVcdFile, zext_ln31_reg_616, "zext_ln31_reg_616");
    sc_trace(mVcdFile, icmp_ln30_fu_442_p2, "icmp_ln30_fu_442_p2");
    ...
    sc_trace(mVcdFile, icmp_ln39_fu_478_p2, "icmp_ln39_fu_478_p2");
    ...
    sc_trace(mVcdFile, zext_ln44_fu_525_p1, "zext_ln44_fu_525_p1");
    sc_trace(mVcdFile, zext_ln44_reg_671, "zext_ln44_reg_671");
    ...
    sc_trace(mVcdFile, zext_ln40_1_fu_490_p1, "zext_ln40_1_fu_490_p1");
    sc_trace(mVcdFile, zext_ln40_fu_496_p1, "zext_ln40_fu_496_p1");
    ...
    sc_trace(mVcdFile, add_ln40_fu_484_p2, "add_ln40_fu_484_p2");
...
void sort::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read())) {
        i6_0_reg_373 = i_3_fu_508_p2.read();
                ...
                esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln30_fu_442_p2.read()))) {
        i6_0_reg_373 = ap_const_lv5_1;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln25_fu_425_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln25_fu_425_p2.read()))) {
        j5_0_reg_362 = ap_const_lv32_0;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        j5_0_reg_362 = j_1_reg_611.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln39_fu_478_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(icmp_ln18_fu_396_p2.read(), ap_const_lv1_1))) {
        op2_assign_reg_339 = ap_const_lv6_0;
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state12.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln43_fu_514_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln18_fu_396_p2.read(), ap_const_lv1_0))) {
        zext_ln19_reg_571 = zext_ln19_fu_407_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        zext_ln23_reg_592 = zext_ln23_fu_413_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln30_fu_442_p2.read()))) {
        zext_ln31_reg_616 = zext_ln31_fu_453_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state12.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln43_fu_514_p2.read()))) {
        zext_ln44_reg_671 = zext_ln44_fu_525_p1.read();
    }
}
...
void sort::thread_add_ln40_fu_484_p2() {
    add_ln40_fu_484_p2 = (!i6_0_reg_373.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_biguint<5>(i6_0_reg_373.read()) + sc_bigint<5>(ap_const_lv5_1F));
}
...
void sort::thread_current_digit_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state12.read())) {
        current_digit_V_address0 =  (sc_lv<8>) (zext_ln44_fu_525_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        current_digit_V_address0 =  (sc_lv<8>) (zext_ln31_reg_616.read());
    } else {
...
void sort::thread_digit_histogram_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        digit_histogram_V_address0 =  (sc_lv<4>) (zext_ln40_1_fu_490_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        ...
        digit_histogram_V_address0 =  (sc_lv<4>) (zext_ln26_fu_437_p1.read());
    } else {
...
void sort::thread_digit_location_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state14.read())) {
        ...
        digit_location_V_address0 =  (sc_lv<4>) (zext_ln40_fu_496_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        digit_location_V_address0 =  (sc_lv<4>) (zext_ln40_1_fu_490_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
...
void sort::thread_icmp_ln18_fu_396_p2() {
    icmp_ln18_fu_396_p2 = (!j_0_reg_328.read().is_01() || !num_symbols.read().is_01())? sc_lv<1>(): sc_lv<1>(j_0_reg_328.read() == num_symbols.read());
}

void sort::thread_icmp_ln25_fu_425_p2() {
    icmp_ln25_fu_425_p2 = (!i_0_reg_351.read().is_01() || !ap_const_lv5_10.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_351.read() == ap_const_lv5_10);
}

void sort::thread_icmp_ln30_fu_442_p2() {
    icmp_ln30_fu_442_p2 = (!j5_0_reg_362.read().is_01() || !num_symbols.read().is_01())? sc_lv<1>(): sc_lv<1>(j5_0_reg_362.read() == num_symbols.read());
}

void sort::thread_icmp_ln39_fu_478_p2() {
    icmp_ln39_fu_478_p2 = (!i6_0_reg_373.read().is_01() || !ap_const_lv5_10.is_01())? sc_lv<1>(): sc_lv<1>(i6_0_reg_373.read() == ap_const_lv5_10);
}

void sort::thread_icmp_ln43_fu_514_p2() {
    icmp_ln43_fu_514_p2 = (!j7_0_reg_385.read().is_01() || !num_symbols.read().is_01())? sc_lv<1>(): sc_lv<1>(j7_0_reg_385.read() == num_symbols.read());
}

void sort::thread_in_frequency_V_address0() {
    in_frequency_V_address0 =  (sc_lv<8>) (zext_ln19_fu_407_p1.read());
}
...
void sort::thread_in_value_V_address0() {
    in_value_V_address0 =  (sc_lv<8>) (zext_ln19_fu_407_p1.read());
}
...
void sort::thread_lshr_ln1503_fu_458_p2() {
    lshr_ln1503_fu_458_p2 = (!zext_ln23_reg_592.read().is_01())? sc_lv<32>(): sorting_frequency_V_q0.read() >> (unsigned short)zext_ln23_reg_592.read().to_uint();
}
...
void sort::thread_previous_sorting_fre_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read())) {
        previous_sorting_fre_address0 =  (sc_lv<8>) (zext_ln44_reg_671.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        previous_sorting_fre_address0 =  (sc_lv<8>) (zext_ln31_reg_616.read());
    } else {
...
void sort::thread_previous_sorting_val_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read())) {
        previous_sorting_val_address0 =  (sc_lv<8>) (zext_ln44_reg_671.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        previous_sorting_val_address0 =  (sc_lv<8>) (zext_ln31_reg_616.read());
    } else {
...
void sort::thread_sorting_frequency_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state14.read())) {
        ...
        sorting_frequency_V_address0 =  (sc_lv<8>) (zext_ln31_fu_453_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        sorting_frequency_V_address0 =  (sc_lv<8>) (zext_ln19_reg_571.read());
    } else {
...
void sort::thread_sorting_value_V_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state14.read())) {
        ...
        sorting_value_V_address0 =  (sc_lv<8>) (zext_ln31_reg_616.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        sorting_value_V_address0 =  (sc_lv<8>) (zext_ln19_reg_571.read());
    } else {
...
void sort::thread_zext_ln19_fu_407_p1() {
    zext_ln19_fu_407_p1 = esl_zext<64,32>(j_0_reg_328.read());
}

void sort::thread_zext_ln23_fu_413_p1() {
    zext_ln23_fu_413_p1 = esl_zext<32,6>(op2_assign_reg_339.read());
}

void sort::thread_zext_ln26_fu_437_p1() {
    zext_ln26_fu_437_p1 = esl_zext<64,5>(i_0_reg_351.read());
}

void sort::thread_zext_ln31_fu_453_p1() {
    zext_ln31_fu_453_p1 = esl_zext<64,32>(j5_0_reg_362.read());
}

void sort::thread_zext_ln40_1_fu_490_p1() {
    zext_ln40_1_fu_490_p1 = esl_zext<64,5>(add_ln40_fu_484_p2.read());
}

void sort::thread_zext_ln40_fu_496_p1() {
    zext_ln40_fu_496_p1 = esl_zext<64,5>(i6_0_reg_373.read());
}

void sort::thread_zext_ln44_fu_525_p1() {
    zext_ln44_fu_525_p1 = esl_zext<64,32>(j7_0_reg_385.read());
}
...
void sort::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln18_fu_396_p2.read(), ap_const_lv1_1))) {
        ...
        case 8 : 
            ...
            break;
        case 16 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln25_fu_425_p2.read()))) {
            ...
            break;
        case 32 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln30_fu_442_p2.read()))) {
        ...
        case 256 : 
            ...
            break;
        case 512 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln39_fu_478_p2.read()))) {
        ...
        case 1024 : 
            ...
            break;
        case 2048 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state12.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln43_fu_514_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state4;
            } else {
