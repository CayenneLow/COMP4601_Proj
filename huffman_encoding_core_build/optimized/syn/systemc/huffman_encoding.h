...
struct huffman_encoding : public sc_module {
    ...
    huffman_encoding_lbW* filtered_value_V_U;
    huffman_encoding_lbW* filtered_frequency_V_U;
    huffman_encoding_lbW* sorted_0_U;
    huffman_encoding_lbW* sorted_1_U;
    huffman_encoding_lbW* sorted_copy1_value_V_U;
    huffman_encoding_lbW* sorted_copy1_frequen_U;
    huffman_encoding_lbW* sorted_copy2_value_V_U;
    ...
    sc_signal< sc_lv<32> > length_histogram_V_i_q1;
    sc_signal< sc_lv<32> > length_histogram_V_t_q0;
    sc_signal< sc_lv<32> > length_histogram_V_t_q1;
    ...
    sc_signal< sc_lv<32> > truncated_length_his_1_i_q0;
    sc_signal< sc_lv<32> > truncated_length_his_1_t_q0;
    ...
    sc_signal< sc_lv<6> > truncate_tree_U0_input_length_histogram_V_address1;
    sc_signal< sc_logic > truncate_tree_U0_input_length_histogram_V_ce1;
    ...
    sc_signal< sc_lv<32> > truncate_tree_U0_output_length_histogram2_V_d0;
    sc_signal< sc_lv<6> > truncate_tree_U0_output_length_histogram2_V_address1;
    sc_signal< sc_logic > truncate_tree_U0_output_length_histogram2_V_ce1;
    sc_signal< sc_logic > truncate_tree_U0_output_length_histogram2_V_we1;
    sc_signal< sc_lv<32> > truncate_tree_U0_output_length_histogram2_V_d1;
    ...
    sc_signal< sc_lv<8> > canonize_tree_U0_symbol_bits_V_address1;
    sc_signal< sc_logic > canonize_tree_U0_symbol_bits_V_ce1;
    sc_signal< sc_logic > canonize_tree_U0_symbol_bits_V_we1;
    sc_signal< sc_lv<5> > canonize_tree_U0_symbol_bits_V_d1;
    ...
    sc_signal< sc_lv<32> > length_histogram_V_t_d1;
    sc_signal< sc_logic > length_histogram_V_t_we1;
    ...
    void thread_length_histogram_V_t_d1();
    void thread_length_histogram_V_t_we1();
