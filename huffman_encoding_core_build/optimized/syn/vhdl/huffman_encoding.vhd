...
architecture behav of huffman_encoding is 
    ...
    "huffman_encoding,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.661000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=25,HLS_SYN_DSP=0,HLS_SYN_FF=5125,HLS_SYN_LUT=9108,HLS_VERSION=2020_1}";
    ...
    signal length_histogram_V_i_q1 : STD_LOGIC_VECTOR (31 downto 0);
    signal length_histogram_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal length_histogram_V_t_q1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal truncate_tree_U0_input_length_histogram_V_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal truncate_tree_U0_input_length_histogram_V_ce1 : STD_LOGIC;
    ...
    signal truncate_tree_U0_output_length_histogram2_V_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal truncate_tree_U0_output_length_histogram2_V_ce1 : STD_LOGIC;
    signal truncate_tree_U0_output_length_histogram2_V_we1 : STD_LOGIC;
    signal truncate_tree_U0_output_length_histogram2_V_d1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal canonize_tree_U0_symbol_bits_V_address1 : STD_LOGIC_VECTOR (7 downto 0);
    signal canonize_tree_U0_symbol_bits_V_ce1 : STD_LOGIC;
    signal canonize_tree_U0_symbol_bits_V_we1 : STD_LOGIC;
    signal canonize_tree_U0_symbol_bits_V_d1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal length_histogram_V_t_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal length_histogram_V_t_we1 : STD_LOGIC;
    ...
    port (
        ...
        symbol_bits_V_address1 : OUT STD_LOGIC_VECTOR (7 downto 0);
        symbol_bits_V_ce1 : OUT STD_LOGIC;
        symbol_bits_V_we1 : OUT STD_LOGIC;
        symbol_bits_V_d1 : OUT STD_LOGIC_VECTOR (4 downto 0) );
    end component;
    ...
    port (
        ...
        t_ce1 : IN STD_LOGIC;
        t_we1 : IN STD_LOGIC;
        t_d1 : IN STD_LOGIC_VECTOR (4 downto 0);
        i_ce : IN STD_LOGIC;
        t_ce : IN STD_LOGIC;
        i_full_n : OUT STD_LOGIC;
        i_write : IN STD_LOGIC;
...
begin
    ...
    truncated_length_his_1_U : component huffman_encoding_xdS
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
