...
reg   [31:0] i2_0_i_i_reg_212;
reg   [31:0] val_assign_loc_read_reg_328;
reg    ap_block_state1;
wire   [6:0] i_3_fu_241_p2;
wire    ap_CS_fsm_state2;
wire   [31:0] i_fu_262_p2;
...
wire   [0:0] icmp_ln883_fu_287_p2;
reg   [0:0] icmp_ln883_reg_376;
wire   [0:0] icmp_ln883_1_fu_293_p2;
reg   [0:0] icmp_ln883_1_reg_380;
wire   [63:0] zext_ln544_8_fu_306_p1;
reg   [63:0] zext_ln544_8_reg_384;
wire    ap_CS_fsm_pp1_stage2;
wire    ap_block_state6_pp1_stage2_iter0;
wire    ap_block_pp1_stage2_11001;
reg   [5:0] internal_length_hist_2_reg_389;
wire   [31:0] i_4_fu_311_p2;
reg   [31:0] i_4_reg_394;
reg    ap_enable_reg_pp1_iter0;
wire   [31:0] internal_length_hist_q0;
reg   [31:0] count_V_reg_399;
...
reg   [6:0] i_0_i_i_reg_201;
wire   [0:0] icmp_ln14_fu_235_p2;
reg   [31:0] ap_phi_mux_i2_0_i_i_phi_fu_215_p4;
wire    ap_block_pp1_stage0;
wire   [1:0] ap_phi_reg_pp1_iter0_op2_assign_reg_222;
reg   [1:0] ap_phi_reg_pp1_iter1_op2_assign_reg_222;
wire   [63:0] zext_ln16_fu_247_p1;
wire  signed [63:0] sext_ln19_fu_257_p1;
wire   [63:0] zext_ln544_fu_282_p1;
wire    ap_block_pp1_stage1;
wire    ap_block_pp1_stage2;
wire   [31:0] count_V_1_fu_321_p2;
wire   [5:0] length_V_fu_299_p2;
wire   [31:0] add_ln19_fu_252_p2;
wire   [31:0] zext_ln544_7_fu_317_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001) & (((tmp_reg_347 == 1'd0) & (icmp_ln883_1_reg_380 == 1'd1) & (icmp_ln883_reg_376 == 1'd0)) | ((tmp_reg_347 == 1'd0) & (icmp_ln883_reg_376 == 1'd1) & (icmp_ln883_1_reg_380 == 1'd0))))) begin
        ap_phi_reg_pp1_iter1_op2_assign_reg_222 <= 2'd1;
...
always @ (posedge ap_clk) begin
    if (((tmp_reg_347 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((val_assign_loc_out_full_n == 1'b0) | (val_assign_loc_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_0_i_i_reg_201 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln14_fu_235_p2 == 1'd0))) begin
        i_0_i_i_reg_201 <= i_3_fu_241_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001) & ((icmp_ln883_1_reg_380 == 1'd0) | (icmp_ln883_reg_376 == 1'd0)))) begin
        count_V_reg_399 <= internal_length_hist_q0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_347 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage2) & (1'b0 == ap_block_pp1_stage2_11001))) begin
        i_4_reg_394 <= i_4_fu_311_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_reg_347 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage1) & (1'b0 == ap_block_pp1_stage1_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage2) & (1'b0 == ap_block_pp1_stage2_11001) & (((tmp_reg_347 == 1'd0) & (icmp_ln883_reg_376 == 1'd0)) | ((tmp_reg_347 == 1'd0) & (icmp_ln883_1_reg_380 == 1'd0))))) begin
        internal_length_hist_2_reg_389 <= zext_ln544_8_fu_306_p1;
        zext_ln544_8_reg_384[5 : 0] <= zext_ln544_8_fu_306_p1[5 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_reg_347 <= ap_phi_mux_i2_0_i_i_phi_fu_215_p4[32'd31];
    end
end
...
always @ (*) begin
    if (((tmp_reg_347 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage2) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage2))) begin
        ...
        child_depth_V_address0 = sext_ln19_fu_257_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((tmp_reg_347 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage2) & (1'b0 == ap_block_pp1_stage2_11001)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage1))) begin
        ...
        internal_length_hist_address0 = zext_ln544_8_fu_306_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        internal_length_hist_address0 = zext_ln16_fu_247_p1;
    end else begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state2) & (icmp_ln14_fu_235_p2 == 1'd0)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage1) & (1'b0 == ap_block_pp1_stage1_11001) & ((icmp_ln883_1_reg_380 == 1'd0) | (icmp_ln883_reg_376 == 1'd0))))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage1) & (1'b0 == ap_block_pp1_stage1_11001) & ((icmp_ln883_1_reg_380 == 1'd0) | (icmp_ln883_reg_376 == 1'd0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln14_fu_235_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if ((~((tmp_fu_267_p3 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0)) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage1;
            end else if (((tmp_fu_267_p3 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0))) begin
...
assign add_ln19_fu_252_p2 = ($signed(val_assign_loc_read_reg_328) + $signed(32'd4294967294));
...
assign ap_phi_reg_pp1_iter0_op2_assign_reg_222 = 2'd2;

assign count_V_1_fu_321_p2 = (count_V_reg_399 + zext_ln544_7_fu_317_p1);

assign i_3_fu_241_p2 = (i_0_i_i_reg_201 + 7'd1);

assign i_4_fu_311_p2 = ($signed(i2_0_i_i_reg_212) + $signed(32'd4294967295));

assign i_fu_262_p2 = ($signed(val_assign_loc_read_reg_328) + $signed(32'd4294967293));

assign icmp_ln14_fu_235_p2 = ((i_0_i_i_reg_201 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln883_1_fu_293_p2 = ((right_V_q0 == 32'd4294967295) ? 1'b1 : 1'b0);
...
assign length_histogram_V_address0 = zext_ln544_8_reg_384;
...
assign tmp_fu_267_p3 = ap_phi_mux_i2_0_i_i_phi_fu_215_p4[32'd31];
...
assign zext_ln544_8_fu_306_p1 = length_V_fu_299_p2;
