...
set C_modelArgList {
	{ input_length_histogram_V int 32 regular {array 64 { 1 1 } 1 1 }  }
	{ output_length_histogram1_V int 32 regular {array 64 { 2 2 } 1 1 }  }
	{ output_length_histogram2_V int 32 regular {array 64 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ input_length_histogram_V_address1 sc_out sc_lv 6 signal 0 } 
	{ input_length_histogram_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ input_length_histogram_V_q1 sc_in sc_lv 32 signal 0 } 
	...
	{ output_length_histogram2_V_address1 sc_out sc_lv 6 signal 2 } 
	{ output_length_histogram2_V_ce1 sc_out sc_logic 1 signal 2 } 
	{ output_length_histogram2_V_we1 sc_out sc_logic 1 signal 2 } 
	{ output_length_histogram2_V_d1 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_length_histogram_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "input_length_histogram_V", "role": "address1" }} , 
 	{ "name": "input_length_histogram_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_length_histogram_V", "role": "ce1" }} , 
 	{ "name": "input_length_histogram_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "input_length_histogram_V", "role": "q1" }} , 
 	...
 	{ "name": "output_length_histogram2_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "output_length_histogram2_V", "role": "address1" }} , 
 	{ "name": "output_length_histogram2_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_length_histogram2_V", "role": "ce1" }} , 
 	{ "name": "output_length_histogram2_V_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_length_histogram2_V", "role": "we1" }} , 
 	{ "name": "output_length_histogram2_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_length_histogram2_V", "role": "d1" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "input_length_histogram_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "output_length_histogram1_V", "Type" : "Memory", "Direction" : "IO", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "output_length_histogram2_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1145", "Max" : "1253"}
	, {"Name" : "Interval", "Min" : "1145", "Max" : "1253"}
]}
...
set Spec2ImplPortList { 
	input_length_histogram_V { ap_memory {  { input_length_histogram_V_address0 mem_address 1 6 }  { input_length_histogram_V_ce0 mem_ce 1 1 }  { input_length_histogram_V_q0 mem_dout 0 32 }  { input_length_histogram_V_address1 MemPortADDR2 1 6 }  { input_length_histogram_V_ce1 MemPortCE2 1 1 }  { input_length_histogram_V_q1 MemPortDOUT2 0 32 } } }
	...
	output_length_histogram2_V { ap_memory {  { output_length_histogram2_V_address0 mem_address 1 6 }  { output_length_histogram2_V_ce0 mem_ce 1 1 }  { output_length_histogram2_V_we0 mem_we 1 1 }  { output_length_histogram2_V_d0 mem_din 1 32 }  { output_length_histogram2_V_address1 MemPortADDR2 1 6 }  { output_length_histogram2_V_ce1 MemPortCE2 1 1 }  { output_length_histogram2_V_we1 MemPortWE2 1 1 }  { output_length_histogram2_V_d1 MemPortDIN2 1 32 } } }
}
